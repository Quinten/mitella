package mitella.animations {
	...
	public class Springy extends Animation {
		...
		public function Springy(targetMC:MovieClip, propertyName:String, home:Number, springiness:Number = .2, decay:Number = .8, change:Number = 0, restless:Boolean = false, autoStart:Boolean = true):void
		{
